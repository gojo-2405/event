...
-- Dev RDS Pepsi demo seed
--
-- Run with:
--   PGPASSWORD='<dev-rds-password>' \
--   psql "postgresql://<dev-rds-user>@<dev-rds-host>:5432/<dev-rds-db>?sslmode=require" \
--     -f packages/database/prisma/sql/dev-pepsi-demo-rds.sql
--
-- Demo credentials
...
--
-- Notes
-- - This seeds a separate Pepsi tenant for dev-RDS demos only.
...
INSERT INTO guest (
  ...
  ((SELECT id FROM demo_guest_ids WHERE key = 'almost_full_sjp'), '00000000-0000-0000-0000-000000000099', 'SJP', 'Selvaraj', 'sjp@pepsi.com', 'Pepsi', '2026-07-19T10:00:00Z', now()),
  ((SELECT id FROM demo_guest_ids WHERE key = 'almost_full_daksh'), '00000000-0000-0000-0000-000000000099', 'Daksh', 'Panchal', 'daksh.panchal@pepsi.com', 'Pepsi', '2026-07-19T10:45:00Z', now()),
  ((SELECT id FROM demo_guest_ids WHERE key = 'almost_full_meera'), '00000000-0000-0000-0000-000000000099', 'Meera', 'Iyer', 'meera.iyer@pepsi.com', 'Pepsi', '2026-07-19T11:30:00Z', now()),
  ((SELECT id FROM demo_guest_ids WHERE key = 'full_sjp'), '00000000-0000-0000-0000-000000000099', 'SJP', 'Selvaraj', 'sjp@pepsi.com', 'Pepsi', '2026-07-18T18:40:00Z', now()),
  ((SELECT id FROM demo_guest_ids WHERE key = 'full_daksh'), '00000000-0000-0000-0000-000000000099', 'Daksh', 'Panchal', 'daksh.panchal@pepsi.com', 'Pepsi', '2026-07-18T18:50:00Z', now()),
  ((SELECT id FROM demo_guest_ids WHERE key = 'full_meera'), '00000000-0000-0000-0000-000000000099', 'Meera', 'Iyer', 'meera.iyer@pepsi.com', 'Pepsi', '2026-07-18T19:00:00Z', now()),
  ((SELECT id FROM demo_guest_ids WHERE key = 'waitlisted_sjp'), '00000000-0000-0000-0000-000000000099', 'SJP', 'Selvaraj', 'sjp@pepsi.com', 'Pepsi', '2026-07-17T19:20:00Z', now()),
  ((SELECT id FROM demo_guest_ids WHERE key = 'waitlisted_daksh'), '00000000-0000-0000-0000-000000000099', 'Daksh', 'Panchal', 'daksh.panchal@pepsi.com', 'Pepsi', '2026-07-17T19:30:00Z', now());
